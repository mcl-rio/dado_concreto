...
function loadPanel(serverFunction, initCallback) {
  callServer(serverFunction).then(function(html) {
    ...
    // innerHTML nao executa <script> — recriar manualmente
    ...
    document.getElementById('content-area').innerHTML =
      '<div class="card text-center"><p class="text-muted">Erro ao carregar painel: '
      + (err && err.message ? err.message : 'desconhecido') + '</p></div>';
  });
}
